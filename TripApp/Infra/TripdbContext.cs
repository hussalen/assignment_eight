...
public partial class TripdbContext : DbContext
{
    ...
    public TripdbContext(IConfiguration configuration, DbContextOptions<TripdbContext> options)
        : base(options)
    {
        //dotnet ef dbcontext scaffold 'Data Source=localhost,1433;TrustServerCertificate=true;User ID=sa;Password=???;' Microsoft.EntityFrameworkCore.SqlServer -o Model
        _connectionString =
